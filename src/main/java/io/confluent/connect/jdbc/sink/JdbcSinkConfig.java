...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  public static String upSetAppend = JdbcSinkConfig(Map<?, ?> props).updateSetAppend;
  public static String upWhereAppend = JdbcSinkConfig(Map<?, ?> props).updateWhereAppend;
